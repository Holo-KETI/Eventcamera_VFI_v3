...
def traintest_BSERGB_x5AdamwithLPIPS_vali(args):
    paths = ED()
    ...
    paths.save = ED()
    paths.save.save_path = './x5_interpolation_gopro_bsegrb'
    ...
    model_config.define_model.num_decoder = 12
    model_config.define_model.echannel = 120

    training_config = ED()
    training_config.dataloader = 'loader_bsergb'
    training_config.crop_size = 384   
    training_config.num_workers = 16   
    training_config.batch_size = 1   
    # training_config.crop_size =  64
    ...
    training_config.interp_ratio = 10
    ...
    training_config.events_channel = 120
    ...
    validation_config.interp_ratio = 10
    ...
    validation_config.events_channel = 120
