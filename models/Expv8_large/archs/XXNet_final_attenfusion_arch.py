...
class FinalBidirectionAttenfusion(nn.Module):
	...
	def forward(self, x, event, interp_ratio, end_time):
		"""
		...
		for t_ in [0, 1, 2, 3, 4, 5, 6, 7]:
			...
			forward_ims.append(self.decoder_0.backwarp(im0, forward_cur_flow_large,576, 928))
			# [1, 3, 576, 928], [1, 2, 576, 928]
			backward_ims.insert(0, self.decoder_0.backwarp(im1, backward_cur_flow_large,576, 928))
			# [1, 3, 576, 928], [1, 2, 576, 928]
